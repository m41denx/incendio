...
export const storagePoolFormFieldToPayloadName: Record<string, string> = {
  ...
  ceph_osd_data_pool_name: "ceph.osd.data_pool_name",
  ceph_rbd_backend: "ceph.rbd.backend",
  ...
  cephfs_data_pool: "cephfs.data_pool",
  cephfs_meta_pool: "cephfs.meta_pool",
  ...
  cephobject_radosgw_endpoint_cert: "cephobject.radosgw.endpoint_cert",
