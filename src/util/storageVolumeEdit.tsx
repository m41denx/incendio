...
export const getStorageVolumeEditValues = (
  ...
  return {
    ...
    btrfs_compression: volume.config["btrfs.compression"],
    initial_uid: volume.config["initial.uid"],
    initial_gid: volume.config["initial.gid"],
    initial_mode: volume.config["initial.mode"],
    readOnly: true,
    isCreating: false,
