...
const KubernetesClusterDetail = lazy(
  async () => import("pages/kubernetes/ClusterDetail"),
);
...
const ProjectUsage = lazy(async () => import("pages/projects/ProjectUsage"));
const ProjectAccess = lazy(async () => import("pages/projects/ProjectAccess"));
  ...
  return (
    ...
    >
      <Routes>
        ...
        />
        <Route
          path={`${ROOT_PATH}/ui/project/:project/access`}
          element={
            <ProtectedRoute
              outlet={<ProjectLoader outlet={<ProjectAccess />} />}
            />
          }
        />
        <Route
        ...
        />
        <Route
          path={`${ROOT_PATH}/ui/kubernetes/cluster/:name`}
          element={<ProtectedRoute outlet={<KubernetesClusterDetail />} />}
        />
        <Route
