...
export const toStoragePoolFormValues = (
  ...
  return {
    ...
    ceph_osd_data_pool_name: pool.config?.["ceph.osd.data_pool_name"],
    ceph_rbd_backend: pool.config?.["ceph.rbd.backend"],
    ...
    cephfs_data_pool: pool.config?.["cephfs.data_pool"],
    cephfs_meta_pool: pool.config?.["cephfs.meta_pool"],
    ...
    cephobject_radosgw_endpoint_cert:
      pool.config?.["cephobject.radosgw.endpoint_cert"],
...
export const handleConfigKeys = [
  ...
  "cephfs.data_pool",
  "cephfs.meta_pool",
  "cephobject.radosgw.endpoint_cert",
  "zfs.clone_copy",
  "zfs.export",
  "zfs.pool_name",
  "lvm.vg_name",
