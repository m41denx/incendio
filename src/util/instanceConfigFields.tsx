const instanceConfigFormFieldsToPayload: Record<string, string> = {
  ...
  limits_cpu_allowance: "limits.cpu.allowance",
  limits_cpu_nodes: "limits.cpu.nodes",
  limits_cpu_priority: "limits.cpu.priority",
  limits_hugepages_1GB: "limits.hugepages.1GB",
  limits_hugepages_1MB: "limits.hugepages.1MB",
  limits_hugepages_2MB: "limits.hugepages.2MB",
  limits_hugepages_64KB: "limits.hugepages.64KB",
  limits_memory_enforce: "limits.memory.enforce",
  limits_memory_hotplug: "limits.memory.hotplug",
  ...
  oci_entrypoint: "oci.entrypoint",
  oci_cwd: "oci.cwd",
  oci_uid: "oci.uid",
  oci_gid: "oci.gid",
  oci_dns_domain: "oci.dns.domain",
  oci_dns_nameservers: "oci.dns.nameservers",
  oci_dns_search: "oci.dns.search",
